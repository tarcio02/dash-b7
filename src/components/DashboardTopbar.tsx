      ...
      <div className="flex flex-1 items-center gap-4">
        <div>
          <h2 className="text-lg font-semibold text-foreground">
            {greeting}, <span className="text-primary">Yury Nóbrega</span>
          </h2>
          <p className="text-xs text-muted-foreground">Bem-vindo ao painel de controle</p>
        </div>
      </div>
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="gap-2 px-2 bg-white/30 border border-white">
              <Avatar className="h-7 w-7">
                <AvatarImage src={administrador} alt="Admin" />
                <AvatarFallback>AD</AvatarFallback>
              </Avatar>
              <span className="hidden md:inline text-sm font-medium  text-[hsl(215,20%,75%)]">Admin</span>
