        ...
        export function DashboardTopbarColaborador() {
        ...
        <div>
            ...
            {greeting}, <span className="text-primary">Nome do Colaborador</span>
            </h2>
            <p className="text-xs text-muted-foreground">Bem-vindo ao painel de tarefas</p>
        </div>
        </div>
